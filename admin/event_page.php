                    ...
                    <?php else: ?>
                        ...
                        <?php if ($numImages > 0): ?>
                            ...
                            <form id="downloadForm" method="post"
                                ...
                                <button class="btn btn-link " type="submit" name="approve_all">Approve all items for this
                                    folder!</button>

                                <h5 style="font-size:20px; font-weight:lighter;">Images directly uploaded for this folder:
                                </h5>
                        ...
                        <?php if ($numVideos > 0): ?>
                            <h5 style="font-size:25px; font-weight:lighter;">Videos directly uploaded for this folder:</h5>
                            <br>
