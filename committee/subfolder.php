...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
        ...
        <body>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown" style="margin-top: 8px;">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                                ...
                                Notifications <span
                                    class="badge badge-primary"><?php echo mysqli_num_rows($resultNotifications); ?></span>
                            </a>
            ...
            <div class="wrapper">
                ...
                <a href="view_rejected_items.php?event_id=<?php echo $eventId; ?>" id="b2" class="btn">Rejected
                    Items</a>
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="addfolder.php" method="post">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="subfolderName" name="folderName"
                                                required>
                    ...
                    <?php if ($numImages > 0): ?>
                        ...
                        <form id="downloadForm" method="post" action="process_selected_images.php?event_id=<?php echo $eventId; ?>">
                            <div class="grid-container">
                                ...
                                $mediaQuery = "SELECT * FROM mediafile WHERE event_id = '$eventId' AND file_type = 'photo'";
